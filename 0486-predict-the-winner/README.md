<h2><a href="https://leetcode.com/problems/predict-the-winner/?envType=problem-list-v2&envId=recursion">486. Predict the Winner</a></h2><h3>Medium</h3><hr><p>You are given an integer array <code>nums</code>.</p>
